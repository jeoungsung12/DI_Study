...
/*
 ...
 => 하위모듈에서의 코드 변화가 상위 모듈에 영향을 미치지 않도록
 => 식당이 바뀌거나 주인장이 바뀌더라도 휴님의 코드에 영향이 없으려면 어떻게 개선할 수 있을까?
 => 해결: 구현체가 아니라 추상화(protocol, Interface)에 의존한다.
 => 인터페이스로 의존 관계를 추상화를 해보자!
 */
//
////손님
//final class Hue {
//    private var food = BranFood()
//    
//    func 점심() -> String {
//        food.메뉴A()
//    }
